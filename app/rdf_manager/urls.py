...
from .views import upload_ttl, add_namespace, homepage, create_database, connect_database, get_active_database, get_active_repository, get_files, createActualDB, destroyDB, retrieveDBlogs, retrieveDBcontainers
